    ...
    <section class="backend admin">
        <div class="wrapper">
            ...
            <?php if(mysqli_num_rows($result) >= 1) { ?>
                ...
                <input id="umfrageBeenden" type="button" class="btn" value="Umfrage speichern und beenden">
                <a id="umfrageLoeschen" href="#">Umfrage löschen</a>
            ...
            <div class="hinweis deleted">
                <img class="icon icons8-Attention" src="data:image/png;base64," width="48" height="48">
                <h3>Die Umfrage wurde gelöscht und nicht gespeichert.</h3>
                <a class="btn">Okay</a>
            </div>
    ...
    <section class="backend alte_umfragen" id="bisherigeUmfragen">
        <div class="wrapper">
            <div class="flexbox-box">
                ...
                <?php
                    $getumfrage_sql = "SELECT frage, antwort1, img1, clicks1, antwort2, img2, clicks2, id FROM alte_umfragen ORDER BY id DESC";
